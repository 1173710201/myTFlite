...
#define LOGV(...) __android_log_print(ANDROID_LOG_VERBOSE, "my_delegate", __VA_ARGS__) 
#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG , "my_delegate", __VA_ARGS__)
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO  , "my_delegate", __VA_ARGS__)
#define LOGW(...) __android_log_print(ANDROID_LOG_WARN  , "my_delegate", __VA_ARGS__)
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR  , "my_delegate", __VA_ARGS__)
namespace tflite {
namespace {
...
TfLiteStatus DelegatePrepare(TfLiteContext* context,
  ...
  supported_nodes.push_back(9);
  supported_nodes.push_back(8);
  supported_nodes.push_back(18);
  supported_nodes.push_back(19);
  LOGI("%s delegate: %d nodes delegated out of %d nodes with "
                  "%d partitions.\n",
