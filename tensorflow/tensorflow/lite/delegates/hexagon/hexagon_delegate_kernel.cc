...
#define LOGV(...) __android_log_print(ANDROID_LOG_VERBOSE, "dsp_delegate", __VA_ARGS__) 
#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG , "dsp_delegate", __VA_ARGS__)
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO  , "dsp_delegate", __VA_ARGS__)
#define LOGW(...) __android_log_print(ANDROID_LOG_WARN  , "dsp_delegate", __VA_ARGS__)
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR  , "dsp_delegate", __VA_ARGS__)
namespace tflite {
